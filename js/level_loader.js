...
var levelOrderArray = [ // Track 1
                        ...
                        [ {video: video_green,          playable: true,  card: card_video_cross}, 
                          {level: level_Diamond345,     playable: false,  card: card_house}, 
                          {level: level_house2,         playable: false,  card: card_house}, 
                          {level: level_DiamondFive,    playable: false,  card: card_house}, 
                          {level: level_Clover,         playable: false,  card: card_house}, 
                          {level: level_hypercube,      playable: false,  card: card_house}, 
                          {level: level_SuperSonic,     playable: false,  card: card_house}, 
                          {level: level_ArrowHead,      playable: false,  card: card_house}, 
                          {level: level_christmas,      playable: false,  card: card_house}, 
                          {level: level_stealth,        playable: false,  card: card_house}, 
                        ],
                        // Track 6
                        [ {video: video_blue,               playable: true,  card: card_video_many}, 
                          {level: level_BaseBallDiamond,    playable: false,  card: card_house}, 
                          {level: level_bomberplane,        playable: false,  card: card_house}, 
                          {level: level_glider,             playable: false,  card: card_house}, 
                          {level: level_hammer,             playable: false,  card: card_house}, 
                          {level: level_hot_air_balloon,    playable: false,  card: card_house}, 
                          {level: level_paper_bird,         playable: false,  card: card_house}, 
                          {level: level_Stairs,             playable: false,  card: card_house}, 
                          {level: level_box3D,              playable: false,  card: card_house}, 
                          {level: level_tangram_hard,       playable: false,  card: card_house}, 
                        ]
                    ];
